...
import { FirstPersonCameraComponent } from "../Components/Babylon/FirstPersonCamera.component";
...
import { PlayerControlsComponent } from "../Components/Player/PlayerControls.component";
import { PlayerInventoryComponent } from "../Components/Player/PlayerInventory.component";
import { PlayerHandsComponent } from "../Components/Player/PlayerHands.component";
import { PlayerToolsComponent } from "../Components/Player/PlayerTools.component";
...
import { DebugCameraComponent } from "../Components/Babylon/DebugCamera.component";
...
import { PlayerEffectsComponent } from "../Components/Player/PlayerEffects.component";
...
export default async function (dver: DivineVoxelEngineRender, graph: Graph) {
  const playerNode = graph
    .addNode(
      ...
      GameManager.currentGameNode.index!,
    )
    .cloneCursor();
